    ...
    <nav className="py-2">
      <div className="container flex justify-between items-center">
        ...
        <div className="flex gap-2 items-center">
          ...
          <form className="w-[450px] mx-auto nav-search">
            ...
            <div className="relative">
              ...
              <Link
                to={"/"}
                className="absolute cursor-pointer z-10 top-1/2 -translate-y-1/2 end-5 border-s flex items-center ps-3 pointer-events-none"
              >
        ...
        <div className="font-bold text-sm">
          <button className="px-8 py-3.5 text-gray-400 hover:scale-[102%] hover:text-white">
            Sign up
          </button>
          <Link
            to={"/login"}
            className="text-black rounded-full bg-white px-9 py-3.5 hover:scale-[103%] hover:bg-slate-200"
          >
            Log in
          </Link>
        </div>
